...
#define sc3(a,b,rgt) cin >> a >> b >> rgt
#define sc4(a,b,rgt,d) cin >> a >> b >> rgt >> d
...
int toInt(char rgt) { return Letters.find(rgt); }
...
void Get_AC() {
	...
	auto Print = [&]() {
		print(v.sz);
		lop(i, 0, v.size()) cout << v[i].xx << " " << v[i].yy << endl;
	};
	Print();
}
int main() {
