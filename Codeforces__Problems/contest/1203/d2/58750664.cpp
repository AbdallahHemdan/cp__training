...
* Even if you don't acceit my solution, you should respect my effort.
* I hope my code compiles and gets acceited.
*  ___   __
* |\  \|\  \
* \ \  \_\  \
*  \ \   ___ \emdan
...
void GO() {
	...
	ans = max({ ok_2[0],s.sz - 1 - ok_1[t.sz - 1] });
	lop(i, 0, t.sz - 1) {
		ans = max({ ans, ok_2[i + 1] - ok_1[i] - 1 });
	}
	print(ans);
}
int main()
