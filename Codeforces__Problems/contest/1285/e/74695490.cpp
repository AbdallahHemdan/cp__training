...
void getAC_ISA() {
    ...
    while(t--) {
        ...
        for (int i = 0; i < n; ++i) {
            int x, y;
            cin >> x >> y;
            events.push_back(make_pair(x, make_pair(1, i)));
            events.push_back(make_pair(y + 1, make_pair(0, i)));
            b[i] = 0;
        }
