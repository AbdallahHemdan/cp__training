...
ll i, n, cnt_1, cnt_2, frq_2[maxn], frq_1[maxn];
string s, t;
void READ() {
	sc3(n, s, t);
	lop(i, 0, n) {
...
void GetAC() {
	...
	if (cnt_1 % 2 == 0) print((cnt_1 + cnt_2) / 2);
	else print((cnt_1 / 2) + (cnt_2 / 2) + 2);
	lop(i, 1, cnt_1 / 2 + 1) cout << frq_1[2 * i] << " " << frq_1[2 * i - 1] << endl;
	lop(i, 1, cnt_2 / 2 + 1) cout << frq_2[2 * i] << " " << frq_2[2 * i - 1] << endl;
	if (cnt_1 & 1) {
		cout << frq_1[cnt_1] << " " << frq_1[cnt_1] << endl;
		cout << frq_1[cnt_1] << " " << frq_2[cnt_2] << endl;
	}
}
int main() {
#ifndef ONLINE_JUDGE
