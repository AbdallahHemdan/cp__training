...
#define sc3(a,b,e) cin >> a >> b >> e
#define sc4(a,b,e,d) cin >> a >> b >> e >> d
...
int toInt(char e) { return Letters.find(e); }
...
void Read() {
	sc2(n, str);
	for (auto e : str) (e == ')') ? r++ : l++;
	if (l != r) re print(-1), void();
	l = 0, r = 0, res = 0;
}
void go() {
	r++;
...
void go2() {
	(l + 1 == r && r != 0) ? res += l + 1 + r, l = 0, r = 0 :
		l++;
}
void getAC() {
	Read();
	for (auto e : str) (e == ')') ? go() : go2();
	print(res);
}
int main() {
#ifndef ONLINE_JUDGE
