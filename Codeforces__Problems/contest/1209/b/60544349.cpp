...
#define mms(Arr, Value) memset(Arr, Value, maxnof(Arr))
...
inline int __builtin_popcountll(__int64 a) {
	return __builtin_popcnt((ui32)a) + __builtin_popcnt(a >> 32);
}
#endif
#endif
